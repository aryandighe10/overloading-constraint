...
UNIVERSITY_END_TIME = datetime.strptime("16:45", "%H:%M") #shouldnt this be 17:45?? 
...
class Data:
    ...
    def generate_class_times(self):
        ...
        for day in DAYS_OF_WEEK:
            current_time = UNIVERSITY_START_TIME #i.e. 8:30
            while OVERLOAD_PREVENTION <= 5 :                                           #THINKING YE VARIABLE SE HOJAIGA
                while current_time + LAB_TIME_SLOT_DURATION <= UNIVERSITY_END_TIME: # so know here we r checking 8:30+2hrs 10:30 <= 16:45
                    if (current_time == BREAKONE_START_TIME or current_time == BREAKTWO_START_TIME ): 
                        ...
                        OVERLOAD_PREVENTION += TIME_SLOT_DURATION              #.......... 
